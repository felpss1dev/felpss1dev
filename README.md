...
Atualmente estudo e desenvolvo projetos usando **Bun, TypeScript e Node.js**, criando APIs utilitárias, divertidas e funcionais.
...
- 🧩 Criação de **APIs REST** com TypeScript
- ⚙️ Rotas utilitárias (texto, matemática, imagens, cores, emojis)
- 🎨 Manipulação de imagens com Canvas
- 🔤 Transformação de textos (emoji, fancy text, unicode)
- 🧮 Lógica matemática (fibonacci, números perfeitos, anagramas)
- 🔐 Validação de dados e parâmetros
- 📦 Organização de projetos e serviços
- 🌱 Aprendizado contínuo em backend e arquitetura
...
![JavaScript](https://img.shields.io/badge/JavaScript-FFD43B?style=for-the-badge&logo=javascript&logoColor=ffffff)
![Python](https://img.shields.io/badge/Python-3178C6?style=for-the-badge&logo=python&logoColor=ffffff)
